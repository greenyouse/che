...
public class ThreadPullLauncher implements Launcher {
    ...
    public ThreadPullLauncher(@Named("schedule.core_pool_size") Integer corePoolSize,
        ...
        this.service = executorServiceWrapper.wrap(
                new CronThreadPoolExecutor(
                        ...
                        new ThreadFactoryBuilder()
                                ...
                                .setDaemon(false)
                                .build()),CronThreadPoolExecutor.class, "org.eclipse.che.commons.schedule.executor.AnnotatedScheduler", ImmutableMap.of("schedule.core_pool_size", corePoolSize.toString()));
    }
